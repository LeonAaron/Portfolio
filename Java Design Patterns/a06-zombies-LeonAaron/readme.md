...
All methods should be public. We are also going to have a few instance variables.  To keep things simple, we are going to make everything static.  There is only one zombieApocalypse, and this is the last base on earth.
